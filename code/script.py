...
# Pairwise aligner initiliased with default BLAST parameters
...
def calculate_p_value(highest_score: float, all_scores: list[float]) -> float:
    ...
    Parameters:
    highest_score: The highest alignment score to evalute 
...
def breed_name_tag(description: str) -> str: 
    ...
    Returns: The breed name obtaied from the description 
    """
